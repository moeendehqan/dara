        ...
        {status === "getNationalcode" ? (
          <>
            <input
              ...
              onChange={(e) =>
                setUserInput({ ...UserInput, nationalCode: e.target.value })
              }
              placeholder="شماره/شناسه ملی"
              type="number"
            />
            <input
              value={UserInput.captcha}
              onChange={(e) =>
                setUserInput({ ...UserInput, captcha: e.target.value })
              }
            ...
            <button className="ent" onClick={applyNationalCode}>
              تایید
            </button>
          </>
        ) : status === "Registered" ? (
          <>
            <h6>لطفا کد تایید را وارد کنید</h6>
            <input
              value={Code}
              onChange={(e) => {
            ...
            />
            <button className="ent" onClick={handleCode}>
              ورود
            </button>
          </>
        ) : (
